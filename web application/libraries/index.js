...
/*			var geojson2 = L.geoJson(WLBoundaries2, {
			...
			dvf3(WLBoundaries2,"properties","GKZ",map2,"map2") 
...
//alert(soildata_substance);
			...
			marker_soildata.bindPopup("Location ID:<br>"+soildata_id+'<br><a name="'+ff+'"  onclick="soildata_detail_sidebar(name)">See details</a>');
